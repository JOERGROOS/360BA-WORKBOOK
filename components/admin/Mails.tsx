...
const MAILS: { gruppe: string; wann: string; betreff: string; text: string; platzhalter: string }[] = [
  ...
  { gruppe: 'Erinnerung · 14 Tage vorher · Workbook UND Finanzdaten fehlen noch', wann: 'Automatisch, sobald der Termin vor Ort in 14 Tagen oder weniger liegt und beides noch fehlt.', betreff: 'mail_erinnerung_14_betreff', text: 'mail_erinnerung_14_text', platzhalter: '{vorname}, {firma}, {link}, {tage}' },
  { gruppe: 'Erinnerung · 14 Tage vorher · nur eine Sache fehlt noch', wann: 'Automatisch an derselben Schwelle, wenn nur noch das Workbook ODER nur noch die Finanzdaten fehlen — {fehlt} wird durch die konkret fehlende Sache ersetzt.', betreff: 'mail_erinnerung_14_teilweise_betreff', text: 'mail_erinnerung_14_teilweise_text', platzhalter: '{vorname}, {firma}, {link}, {tage}, {fehlt}' },
  { gruppe: 'Erinnerung · 10 Tage vorher · Workbook UND Finanzdaten fehlen noch', wann: 'Automatisch, sobald der Termin in 10 Tagen oder weniger liegt und beides noch fehlt.', betreff: 'mail_erinnerung_10_betreff', text: 'mail_erinnerung_10_text', platzhalter: '{vorname}, {firma}, {link}, {tage}' },
  { gruppe: 'Erinnerung · 10 Tage vorher · nur eine Sache fehlt noch', wann: 'Automatisch an derselben Schwelle, wenn nur noch das Workbook ODER nur noch die Finanzdaten fehlen.', betreff: 'mail_erinnerung_10_teilweise_betreff', text: 'mail_erinnerung_10_teilweise_text', platzhalter: '{vorname}, {firma}, {link}, {tage}, {fehlt}' },
  { gruppe: 'Erinnerung · 7 Tage vorher · Workbook UND Finanzdaten fehlen noch', wann: 'Automatisch, sobald der Termin in 7 Tagen oder weniger liegt und beides noch fehlt — letzte Bitte um Workbook und Finanzdaten.', betreff: 'mail_erinnerung_7_betreff', text: 'mail_erinnerung_7_text', platzhalter: '{vorname}, {firma}, {link}, {tage}' },
  { gruppe: 'Erinnerung · 7 Tage vorher · nur eine Sache fehlt noch', wann: 'Automatisch an derselben Schwelle, wenn nur noch das Workbook ODER nur noch die Finanzdaten fehlen.', betreff: 'mail_erinnerung_7_teilweise_betreff', text: 'mail_erinnerung_7_teilweise_text', platzhalter: '{vorname}, {firma}, {link}, {tage}, {fehlt}' },
